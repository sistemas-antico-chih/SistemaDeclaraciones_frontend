...
import { BienInmueble, BienesInmuebles, Catalogo, DeclaracionOutput, valorConstruccion, valorTerreno, valorAdquisicion } from '@models/declaracion';
...
export class BienesInmueblesComponent implements OnInit {
  ...
  setupForm(bienesInmuebles: BienesInmuebles) {
    ...
    //const bienesDeclarante = bienesInmuebles.bienesDeclarante;
